...
DATABASE_NAME = '/home/yhal003/workspace/identity/src/sqlite.db'             # Or path to database file if using sqlite3.
...
SECRET_KEY = 'g!f^b*&4)z4=+01thygxh)z&(m5kjrss3iz-ih%w+#tk=ngy72'
